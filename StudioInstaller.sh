...
DownloadAndroidStudio (){
	...
	wget -c "https://redirector.gvt1.com/edgedl/android/studio/ide-zips/2020.3.1.24/android-studio-2020.3.1.24-linux.tar.gz"
}
...
InstallAndroidStudio (){
	...
	sudo tar -xzf android-studio-2020.3.1.24-linux.tar.gz -C /opt
